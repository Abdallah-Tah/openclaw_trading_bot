...
# ── Exit thresholds ────────────────────────────────────────────────────────────
STOP_LOSS            = _float("STOP_LOSS",              -35.0)   # hard SL %
HARD_ROTATION        = _float("HARD_ROTATION",          -15.0)   # rotate loss %
TAKE_PROFIT_FULL     = _float("TAKE_PROFIT_FULL",       100.0)   # full TP %
PARTIAL_TP_TRIGGER   = _float("PARTIAL_TP_TRIGGER",      40.0)   # partial TP arm %
TRAILING_STOP_ARM    = _float("TRAILING_STOP_ARM",       25.0)   # trail arm % gain
TRAILING_STOP_GIVE   = _float("TRAILING_STOP_GIVE",      18.0)   # max giveback % from peak
...
# ── Position sizing ────────────────────────────────────────────────────────────
DEFAULT_RISK_SOL     = _float("DEFAULT_RISK_SOL",        0.08)  # Increased from 0.05 to 0.08 for $8 trades
HIGH_CONVICTION_SOL  = _float("HIGH_CONVICTION_SOL",     0.12)
